  ...
  nodes: [
    {
      ...
      kind: "single",
      sortOrder: 1,
      question: "¿Cuál es tu papel respecto de este sistema de IA?",
      help: "Proveedor: lo desarrollás o lo comercializás bajo tu marca. Responsable del despliegue (deployer): lo usás en tu actividad. Ambos: las dos cosas.",
      legalRef: "Art. 3 (definiciones)",
      options: [
        { key: "provider", label: "Proveedor (lo desarrollo/comercializo)", flags: ["rol_provider"] },
        { key: "deployer", label: "Responsable del despliegue (lo uso)", flags: ["rol_deployer"] },
        { key: "ambos", label: "Ambos", flags: ["rol_provider", "rol_deployer"] },
      ],
    },
    {
    ...
    },
    {
      ...
      kind: "multi",
      sortOrder: 3,
      question: "¿El sistema se usa en alguno de estos ámbitos?",
      help: "Ámbitos de alto riesgo del Anexo III. La aplicación plena de sus obligaciones está aplazada (hacia 2027-2028); hoy conviene dejar preparado el expediente.",
      legalRef: "Anexo III",
      options: [
